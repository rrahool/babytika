        ...
        <div class="row">
            <div class="col-md-12">
                <div class="w3-bar w3-border w3-light-grey">
                    ...
                    <a href="create_user.php" class="w3-bar-item w3-button" style="text-decoration: none">Create Baby Account</a>
               ...
               <form id="selectionForm" action="trash_multiple.php" method="post">
                    ...
                    <div class="row">
                        <div class="col-sm-12" style="text-align: right;">
                            <a href="create_moderator.php" class="btn w3-indigo w3-hover-indigo" style="text-decoration: none">Create New Baby Account</a>
                        </div>
                    </div>     
